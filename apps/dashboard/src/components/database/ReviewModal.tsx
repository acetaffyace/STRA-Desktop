      ...
      >
        ...
        <div className="mt-3 grid grid-cols-2 gap-2 text-xs sm:grid-cols-4">
          <div className="rounded-lg border border-white/10 bg-slate-950/45 px-2.5 py-2">
            <p className="text-[10px] uppercase tracking-[0.2em] text-slate-500">日期</p>
            <p className="mt-1 text-slate-200">{formatReviewDate(review.created_at)}</p>
          </div>
          <div className="rounded-lg border border-white/10 bg-slate-950/45 px-2.5 py-2">
            <p className="text-[10px] uppercase tracking-[0.2em] text-slate-500">有用</p>
            <p className="mt-1 text-slate-200">{(review.votes_up || 0).toLocaleString()}</p>
          </div>
          <div className="rounded-lg border border-white/10 bg-slate-950/45 px-2.5 py-2">
            <p className="text-[10px] uppercase tracking-[0.2em] text-slate-500">语言</p>
            <p className="mt-1 text-slate-200">{reviewLanguage}</p>
          </div>
          <div className="rounded-lg border border-white/10 bg-slate-950/45 px-2.5 py-2">
            <p className="text-[10px] uppercase tracking-[0.2em] text-slate-500">游戏时长</p>
